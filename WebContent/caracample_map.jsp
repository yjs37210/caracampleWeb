<%@page import="kr.caracampleWeb.model.*"%>
...
<%
	...
	customerVO vo_script = dao.customer_select(num); */
...
<body>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 id="admin_title" class="h3 mb-3">Caracample Map_A</h1>
							...
							<div id="map" class="card">
								<div class="card-header">
									<div id="caracample_map">
										<img id="cara_map" src="./images/map_A.png" alt="없음">
									</div>
									<div></div>
										...
										<thead>
											...
											<tr width="80" height="50">
												...
												<td style="background-color: #fff; text-align: center;"
													class="td_right">${vo.num}</td>
											</tr>
											<tr width="80" height="50">
												<td style="background-color: #eeeeee; text-align: center;">카라반
													이름</td>
												<td style="background-color: #fff; text-align: center;">${vo.car_name}</td>
											</tr>
											<tr width="80" height="50">
												<td style="background-color: #eeeeee; text-align: center;">이름</td>
												<td style="background-color: #fff; text-align: center;">${vo.name}</td>
											</tr>
											<tr width="80" height="50">
												<td style="background-color: #eeeeee; text-align: center;">전화번호</td>
												<td style="background-color: #fff; text-align: center;">${vo.tel }</td>
											</tr>
											<tr width="80" height="50">
												<td style="background-color: #eeeeee; text-align: center;">남성수</td>
												<td style="background-color: #fff; text-align: center;">${vo.male }</td>
											</tr>
											<tr width="80" height="50">
												<td style="background-color: #eeeeee; text-align: center;">여성수</td>
												<td style="background-color: #fff; text-align: center;">${vo.female }</td>
											</tr>
											<tr width="80" height="50">
												<td style="background-color: #eeeeee; text-align: center;">입실시간</td>
												<td style="background-color: #fff; text-align: center;">${vo.check_in }</td>
											</tr>
											<tr width="250" height="50">
												<td style="background-color: #eeeeee; text-align: center;">퇴실시간</td>
												<td style="background-color: #fff; text-align: center;">${vo.check_out }</td>
											</tr>
										</thead>
									</table>
									<!-- <div class="btn_margin">
										<a href="write.jsp" class="btn btn-primary pull-right"
											id="btn_del">수정하기</a> <a href="write.jsp"
											class="btn btn-primary pull-right" id="btn_re">삭제하기</a>
									</div> -->
	...
	<script>
		...
		var num = ${vo.num};
		if (num=='1'){
			document.getElementById('admin_title').innerText='Caracample Map_A';
			var img = document.getElementById('cara_map').src="./images/map_A.png";
		}else if(num=='2'){
			document.getElementById('admin_title').innerText='Caracample Map_B';
			var img = document.getElementById('cara_map').src="./images/map_B.png";
		}else if(num=='3'){
			document.getElementById('admin_title').innerText='Caracample Map_C';
			var img = document.getElementById('cara_map').src="./images/map_C.png";
		}else if(num=='4'){
			document.getElementById('admin_title').innerText='Caracample Map_D';
			var img = document.getElementById('cara_map').src="./images/map_D.png";
		}
	</script>
  -->
