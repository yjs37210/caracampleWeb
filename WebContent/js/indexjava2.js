$(function(){
  ...
  $('.treemenu').on('mouseenter',function(){
                                $(this).find('.colorbox').stop(true).animate({height:'400px'},500);
                                $(this).find('.textbox').stop(true).animate({height:'400px'},500);
                                $(this).find('.textbox').stop(true).animate({bottom:'147.5px'},500);


  });
  $('.treemenu').on('mouseleave',function(){
                                $(this).find('.colorbox').stop(true).animate({height:'105px'},500);
                                $(this).find('.textbox').stop(true).animate({height:'105px'},500);
                                $(this).find('.textbox').stop(true).animate({bottom:'0'},500);
...
/*700이하 trrmenu*/
  $('.smtree').on('mouseenter',function(){
                                $(this).find('.smcolor').stop(true).animate({width:'100%'},500);
  });
  $('.smtree').on('mouseleave',function(){
                                $(this).find('.smcolor').stop(true).animate({width:'400px'},500);
  });
  ...
  $('#banner').each(function () {
    ...
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        var $container = $(this),                                 // a
            ...
            interval = 7000,             // 자동으로 다음 슬라이드로 옮길 때까지의 시간
            timer;                       // 타이머
